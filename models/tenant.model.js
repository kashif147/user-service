...
const TenantSchema = new mongoose.Schema({
  ...
  branding: {
    ...
    primaryColor: { type: String, default: "#215e97" },
    secondaryColor: { type: String, default: "#c97a2f" },
    accentColor: { type: String, default: "#0ea5e9" },
    secondaryBackgroundColor: { type: String, default: "#e6f7ff" },
    portalTitle: { type: String, default: "Project Shell" },
